  ...
  return (
    <div className="space-y-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white sm:text-3xl">Due Today</h2>
          <p className="mt-1 text-sm text-gray-400">Installments scheduled to be paid today.</p>
        </div>
      ...
      {installments.length === 0 ? (
        <EmptyState title="Nothing due today!" description="All caught up. No installments are scheduled for today." />
      ) : (
