  ...
  return (
    <div className="space-y-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white sm:text-3xl">Upcoming Installments</h2>
      ...
      {installments.length === 0 ? (
        <EmptyState title="Nothing upcoming" description="No installments are due in the next 7 days." />
      ) : (
