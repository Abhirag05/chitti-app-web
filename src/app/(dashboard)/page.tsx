  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        />
        <StatCard title="Active Loans" value={stats.totalActiveLoans} />
        <StatCard
          title="Due Today"
      ...
      <div>
        <h3 className="text-xl font-semibold text-white mb-6">Recent Payments</h3>
            ...
            <table className="min-w-full divide-y divide-white/10">
              <thead>
                <tr className="bg-white/5">
                  <th className="py-4 pl-4 pr-3 text-left text-sm font-semibold text-gray-300 sm:pl-6">Borrower</th>
                  <th className="px-3 py-4 text-left text-sm font-semibold text-gray-300">Amount</th>
                  <th className="px-3 py-4 text-left text-sm font-semibold text-gray-300">Loan Ref</th>
                  <th className="px-3 py-4 text-left text-sm font-semibold text-gray-300">Date Paid</th>
                  <th className="px-3 py-4 text-left text-sm font-semibold text-gray-300">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/10">
                {stats.recentPayments.map((payment) => (
                  <tr key={payment.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm font-bold text-emerald-400">
                      ₹{payment.amount.toLocaleString('en-IN')}
                    </td>
                    <td className="whitespace-nowrap px-3 py-4 text-sm font-mono text-gray-400">
